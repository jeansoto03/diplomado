...
try {
    ...
    // Validación
    $requiredFields = ['id', 'rif', 'business_name', 'date', 'total', 'products'];
    ...
    $stmt = $db->prepare("
        UPDATE invoices SET 
        user_id = :user_id, rif = :rif, business_name = :business_name, date = :date, total= :total, products = :products WHERE id = :id
    ");
