...
if (!isset($_SESSION['id']) || !isset($_SESSION['name']) || $_SESSION['rol'] != 1) {
  ...
  require_once '../../back-end/funciones/traerUsuarios.php'
?>
                  ...
                  <tbody>
                    <?php foreach ($resultado as $usuario) { ?>
                      <tr>
                        ...
                        <td data-label="Name"><?php echo $usuario['usuario'] ?></td>
                        <td data-label="Company"><?php echo $usuario['email'] ?></td>
                        <td data-label="City">
                          <?php
                          if ($usuario['tipoUsuario'] == 1) {
                            echo 'Administrador';
                          } elseif ($usuario['tipoUsuario'] == 2) {
                            echo 'registrar salida de producto';
                          } elseif ($usuario['tipoUsuario'] == 3) {
                            echo 'Solo ver reportes';
                          } ?>
                        </td>
